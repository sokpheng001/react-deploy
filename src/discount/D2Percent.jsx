...
import "flowbite";
import { fetchNewProduct } from "../services/product/productAction"; // Ensure this path is correct
import { Carousel3 } from "../components/carousel/Carousel3";
export default function D2Percents() {
  ...
  useEffect(() => {
    async function Getproduct() {
      setLoading(true);
      const fetchData = await fetchNewProduct(); // Ensure fetchNewProduct is working
  ...
  return (
    ...
    <div className="w-[80%] m-auto mt-10">
        <img className="w-full" src="https://dealkh-api.istad.co/images/ba889e68-0298-4252-a119-548ef59562f5.jpeg" alt="..." />
    </div>
              ...
              products
                ...
                .map((val) => (
                  <ProductCard
                    ...
                    price={val.price}
                    discountValue={2}
                    discount={(val.price - (val.price * parseFloat(val.discountValue)) / 100).toFixed(2)}
